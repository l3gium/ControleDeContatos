...
namespace ControleDeContatos.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public UsuarioModel AlterarSenha(AlterarSenhaModel alterarSenhaModel)
        {
            ...
            if (!usuarioDB.SenhaValida(alterarSenhaModel.SenhaAtual)) throw new Exception("Senha atual incorreta");

            if (usuarioDB.SenhaValida(alterarSenhaModel.NovaSenha)) throw new Exception("A senha deve ser diferente da atual");
